...
pub fn stage2() {
    ...
    for line in lines {
        ...
        //number 1 to 2 is range 1
        //number 3 to 4 is range 2

        //if number 1 is inside range 2
        if number1 >= number3 && number1 <= number4 {
            counter += 1;
        }

        //if number 2 is inside range 2
        else if number2 >= number3 && number2 <= number4 {
            counter += 1;
        }

        //if number 3 is inside range 1
        else if number3 >= number1 && number3 <= number2 {
            counter += 1;
        }

        //if number 4 is inside range 1
